...
4. **Plate-Farbe: GRÜN `#00FF00`** (revidiert 15.07. — Recherche-Beweis: Magenta driftet in der i2v-Generierung, Grün ist als „Greenscreen"-Konzept stabil verankert; Details in `prompt-playbook.md`). Das Jeans-Spritzer-Problem ist gelöst: **`master-keysafe.png`** — die ~1.100 Lime-Pixel (0,014 %) auf Orange umgefärbt.
5. **Status:** P1 (frontal) und P4 (Close-up) sind **fertig in Grün** (`plate-P1-frontal-green.png`, `plate-P4-closeup-green.png`; Magenta-Versionen bleiben als Backup im Repo). P2/P3/P5/P6: erst nötig, falls Direkt-i2v (Option A) nicht reicht.
