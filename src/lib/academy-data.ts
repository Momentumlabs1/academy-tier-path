...
export const LESSONS: Lesson[] = [
  { id: "l1", title: "What Is Trading?", description: "Long & short, the markets, and why trading is not investing.", durationMin: 14, tier: "foundation", category: "Foundations", completed: true, youtubeId: DEMO_VIDEO, videoObject: "lesson-01.mp4",
  ...
  { id: "l3", title: "Why 90% of Traders Lose", description: "The avoidable mistakes: no plan, overtrading, revenge trading.", durationMin: 16, tier: "foundation", category: "Risk", completed: false, youtubeId: DEMO_VIDEO, videoObject: "lesson-03.mp4",
  ...
  { id: "l8", title: "What Is Retail Money?", description: "How the crowd trades — and why that's the wrong approach.", durationMin: 13, tier: "operator", category: "Orderflow", youtubeId: DEMO_VIDEO, videoObject: "lesson-04.mp4",
  ...
  { id: "l9", title: "Level 1 vs. Level 2 Data", description: "The information gap between retail and institutions.", durationMin: 15, tier: "operator", category: "Orderflow", youtubeId: DEMO_VIDEO, videoObject: "lesson-05.mp4",
  ...
  { id: "l11", title: "Volume Profile: Value Area, HVN & LVN", description: "Where the market feels comfortable — and where the fast moves happen.", durationMin: 20, tier: "elite", category: "Orderflow", youtubeId: DEMO_VIDEO, videoObject: "lesson-06.mp4",
