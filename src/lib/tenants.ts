...
export const TENANTS: TenantConfig[] = [
  ...
  },
  {
    ...
    pitchVideo: "/zeko-pitch.mp4?v=3",
    pitchPoster: "/zeko-pitch-poster.jpg?v=3",
...
export const COSMOS_MASTER: TenantConfig = {
  ...
  pitchPoster: "/pitch-poster.jpg?v=4",
  affiliateEmail: "kontakt@momentumlabs.at",
...
export const RESERVED_SLUGS = new Set([
  ...
  "registrieren", "willkommen", "signup", "welcome", "reset-password", "team",
